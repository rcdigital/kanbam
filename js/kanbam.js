...
function KanbamRedmine($scope) {
	...
	KanbamRedmine.prototype.getActivities = function() {
		if ( $scope.activities == undefined ) {
			var self = this;
			this.proxy("onLoadActivities", "getActivities", "", true);
		} else {
			//$(".popover .assignedToList").html( $(".popoverTemplate .assignedToList").html() );
		}
	}
	
	KanbamRedmine.prototype.onLoadActivities = function( e ) {	
	...
	KanbamRedmine.prototype.getUsersByProject = function( projectId ) {
		if ( $scope.currentProject.memberships == undefined ) {
			var self = this;
			this.proxy("onLoadUsersByProject", "getUsersByProject", "&id=" + projectId, true);
		} else {
			$(".popover .assignedToList").html( $(".popoverTemplate .assignedToList").html() );
		}
	}
